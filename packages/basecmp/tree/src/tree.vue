...
import { addClass, removeClass, getNodeKey, findNearestComponent } from './model/util';
...
export default {
  ...
  props: {
    ...
    iconClass: String,
    greyBg: Boolean, // 交互灰色背景，默认是白色
    markRootNode: Boolean, // 标记根节点
  },
